		...
		>
			...
			<div className='mb-16'>
				<Reveal>
					...
					<p className='mt-6 max-w-[640px] text-[18px] text-muted leading-[1.6]'>
						Landing page designed and built for an early-stage AI startup
						focused on conscious founders and creators.
					</p>
				</Reveal>
			</div>
			...
			<div className='mt-20 mb-6 flex justify-center lg:justify-start'>
				<Reveal delay={0.1}>
					<a
						href='#contact'
						className='px-8 py-4 bg-accent text-white rounded-2xl text-lg font-semibold shadow-button hover:brightness-110 transition-all duration-300 cursor-pointer lg:hover:scale-102'
					>
						Launch Your Landing
					</a>
				</Reveal>
